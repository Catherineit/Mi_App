...
Future<void> main() async { // Función principal que se ejecuta al iniciar la aplicación
await Firebase.initializeApp(
    options: DefaultFirebaseOptions.currentPlatform,
  ); // Inicializa Firebase con las opciones predeterminadas para la plataforma actual
  runApp(const MainApp()); // Ejecuta la aplicación, mostrando el widget MainApp
}
